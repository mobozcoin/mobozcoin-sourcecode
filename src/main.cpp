...
uint256 hashGenesisBlock("0x00000744cb64e597fb8f1b1ec2f33461dd211377727c8e904f0f8e41ac32840c");
...
{
    // Mobozcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1502811522;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1351716;
