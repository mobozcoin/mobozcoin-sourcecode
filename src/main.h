...
static const int64 MAX_MONEY = 1000000000 * COIN; // Mobozcoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 10) / 250; // Mobozcoin: Priority cutoff is 2 Mobozcoin day / 250 bytes.
    }
